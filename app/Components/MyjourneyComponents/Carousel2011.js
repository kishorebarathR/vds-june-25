...
export default function SimpleSlider() {
  ...
  const imagePaths = [
    "/my-journey/carousel-img-20.png",
    "/my-journey/carousel-img-21.jpeg",
    "/my-journey/carousel-img-19.jpeg",
    "/my-journey/carousel-img-20.png",
    "/my-journey/carousel-img-21.jpeg",
    "/my-journey/carousel-img-19.jpeg",
  ]
        ...
        <div className="bg-white rounded-3xl p-3 mt-5">
          ...
          <div className="lg:flex pb-5">
            ...
            <p className="text-black text-[18px] text-left p-5 mt-5">
                VD Satheeshan&apos;s political career reached new heights during
                this phase. He was re-elected to the assembly and, as a
                testament to his leadership capabilities, was elected as the
                Chairman of the Public Estimate Committee of the legislative
                assembly. Additionally, he was nominated to chair the Joint
                Assembly Committee responsible for investigating allegations
                against the former Chief Minister. His influence expanded beyond
                the state, as he was appointed as the Secretary of the All India
                Congress Committee and also as the Vice President of the Kerala
                Pradesh Congress Committee. In collaboration with other MLAs, he
